            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    <div class="alert alert-success">
                        <center> Formulation Resistance </center>
                    </div>
                    <div class="panel-body no-padding">
                        <div id="formulation_resistance">
...
<script type="text/javascript">
    ...
    {
        $("#formulation_resistance").html("<center><div class='loader'></div></center>");

        $("#formulation_resistance").load("{{ url('dr_formulation/formulation_resistance') }}");
    }
